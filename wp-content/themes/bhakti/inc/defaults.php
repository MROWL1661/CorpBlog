...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			...
			'top_bar_link_color_hover' => '#fee300',
			...
			'navigation_text_hover_color' => '#fee300',
			...
			'subnavigation_text_hover_color' => '#fee300',
			...
			'fixed_side_content_link_hover_color' => '#fee300',
			...
			'blog_header_button_bg' => '#fee300',
			'blog_header_button_hover' => '#000000',
			'blog_header_button_hover_bg' => '#33e2ff',
			...
			'form_button_background_color' => '#fee300',
			'form_button_background_color_hover' => '#33e2ff',
			'form_button_text_color' => '#000000',
			'form_button_text_color_hover' => '#000000',
			'back_to_top_background_color' => '#000000',
			'back_to_top_background_color_hover' => '#fee300',
