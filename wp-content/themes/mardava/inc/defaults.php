...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			...
			'font_body_category' => '',
			'font_body_variants' => '200,300,regular,500,600,700,900',
			'body_font_weight' => '400',
			'body_font_transform' => 'none',
			'body_font_size' => '22',
			'body_line_height' => '1.3', // no unit
			'paragraph_margin' => '1.3', // em
			'font_top_bar' => 'Source Code Pro',
			'font_top_bar_category' => '',
			'font_top_bar_variants' => '200,300,regular,500,600,700,900',
			'top_bar_font_weight' => '400',
			'top_bar_font_transform' => 'none',
			'top_bar_font_size' => '20',
			'font_site_title' => 'Ubuntu',
			'font_site_title_category' => '',
			'font_site_title_variants' => '300,regular,500,700',
			...
			'font_blog_header_title' => 'Source Code Pro',
			'font_blog_header_title_category' => '',
			'font_blog_header_title_variants' => '200,300,regular,500,600,700,900',
			'blog_header_title_font_weight' => '700',
			'blog_header_title_font_transform' => 'none',
			'font_blog_header_text' => 'Source Code Pro',
			'font_blog_header_text_category' => '',
			'font_blog_header_text_variants' => '200,300,regular,500,600,700,900',
			'blog_header_text_font_weight' => '500',
			'blog_header_text_font_transform' => 'none',
			'font_navigation' => 'Source Code Pro',
			'font_navigation_category' => '',
			'font_navigation_variants' => '200,300,regular,500,600,700,900',
			'navigation_font_weight' => '500',
			'navigation_font_transform' => 'uppercase',
			'navigation_font_size' => '22',
			'font_widget_title' => 'Source Code Pro',
			'font_widget_title_category' => '',
			'font_widget_title_variants' => '200,300,regular,500,600,700,900',
			'widget_title_font_weight' => '700',
			'widget_title_font_transform' => 'none',
			'widget_title_font_size' => '30',
			'widget_title_separator' => '18',
			'widget_content_font_size' => '18',
			'font_buttons' => 'Source Code Pro',
			'font_buttons_category' => '',
			'font_buttons_variants' => '200,300,regular,500,600,700,900',
			...
			'font_footer' => 'Source Code Pro',
			'font_footer_category' => '',
			'font_footer_variants' => '200,300,regular,500,600,700,900',
			'footer_weight' => '400',
			'footer_transform' => 'none',
			'footer_font_size' => '20',
			'font_fixed_side' => 'Source Code Pro',
			'font_fixed_side_category' => '',
			'font_fixed_side_variants' => '200,300,regular,500,600,700,900',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Source+Code+Pro:200,300,regular,500,600,700,900|Ubuntu:300,regular,500,700' );
